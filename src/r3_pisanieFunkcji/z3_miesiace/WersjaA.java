package r3_pisanieFunkcji.z3_miesiace;
...
public class WersjaA {
	...
	public static void main(String[] args) {
		...
		if (dni == 1) {
			...
			int rok = Integer.parseInt(JOptionPane.showInputDialog("Podaj rok, którego dotyczy siê Luty:"));
			if (rok%4 == 0) {
				JOptionPane.showMessageDialog(null, miesiacF + " ma 29 dni");
			} else {
